...
//        if (!board[i][p.getY()].hasElement() || board[i][p.getY()].getElement() instanceof Slow || board[i][p.getY()].getElement() instanceof Star) {
//            var x1 = p.getX();
//            var y1 = p.getY();
...
//        if (!board[p.getX()][j].hasElement() || board[p.getX()][j].getElement() instanceof Slow || board[p.getX()][j].getElement() instanceof Star) {
//            var x1 = p.getX();
//            var y1 = p.getY();
